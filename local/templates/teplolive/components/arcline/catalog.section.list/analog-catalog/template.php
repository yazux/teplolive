...
<div class="analog-catalog" xmlns="http://www.w3.org/1999/html">
    <div class="an-title"><div class="title-line"><?if($arParams['RELATED'] == "Y"):?><div>Сопутствующие товары</div><?else:?><div>Аналогичные товары</div><?endif;?></div>
