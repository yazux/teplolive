...
if($arResult["bDescPageNumbering"] === true)
{
	...
	?>
		<div class="navigation-arrows">
			<?if ($bPrevDisabled):?><?else:?><a href="<?=$sPrevHref;?>" id="<?=$ClientID?>_previous_page">«</a><?endif;?>&nbsp;<?if ($bNextDisabled):?><?else:?><a href="<?=$sNextHref;?>" id="<?=$ClientID?>_next_page">»</a><?endif;?>&nbsp;
			</div>
...
else
{
	...
	?>
		<div class="navigation-arrows">
			<?if ($bPrevDisabled):?><?else:?><a class='arrow' href="<?=$sPrevHref;?>" id="<?=$ClientID?>_previous_page">&larr;</a><?endif;?>&nbsp;
				<?
	$bFirst = true;
	$bPoints = false;
	do
...
?>
		<?if ($bNextDisabled):?><?else:?><a class='arrow' href="<?=$sNextHref;?>" id="<?=$ClientID?>_next_page">&rarr;</a><?endif;?>&nbsp;
		</div>
