				...
				<table class="sale_order_full_table">
					<tr>
						<td nowrap><?echo GetMessage("STOF_LOGIN")?> <span class="starrequired">*</span><br />
							<input type="text" class='any'  name="USER_LOGIN" maxlength="30" size="30" value="<?=$arResult["AUTH"]["USER_LOGIN"]?>">&nbsp;&nbsp;&nbsp;</td>
					</tr>
					<tr>
						<td nowrap><?echo GetMessage("STOF_PASSWORD")?> <span class="starrequired">*</span><br />
							<input type="password" class='any'  name="USER_PASSWORD" maxlength="30" size="30">&nbsp;&nbsp;&nbsp;</td>
					</tr>
					<tr>
					...
					<tr>
						<td nowrap>
							<input type="submit" class='auth-button' value="<?echo GetMessage("STOF_NEXT_STEP")?>">
					...
					<table class="sale_order_full_table">
						<tr>
							<td nowrap>
								...
								<input type="text" class='any'  name="NEW_NAME" size="40" value="<?=$arResult["AUTH"]["NEW_NAME"]?>">&nbsp;&nbsp;&nbsp;
							</td>
						</tr>
						<tr>
							<td nowrap>
								<?echo GetMessage("STOF_LASTNAME")?> <span class="starrequired">*</span><br />
								<input type="text" class='any'  name="NEW_LAST_NAME" size="40" value="<?=$arResult["AUTH"]["NEW_LAST_NAME"]?>">&nbsp;&nbsp;&nbsp;
							</td>
						</tr>
						<tr>
							<td nowrap>
								E-Mail <span class="starrequired">*</span><br />
								<input type="text" class='any'  name="NEW_EMAIL" size="40" value="<?=$arResult["AUTH"]["NEW_EMAIL"]?>">&nbsp;&nbsp;&nbsp;
							</td>
						</tr>
						<?if($arResult["AUTH"]["new_user_registration_email_confirmation"] != "Y"):?>
						<tr>
							<td nowrap><input type="radio" id="NEW_GENERATE_N" name="NEW_GENERATE" value="N" OnClick="ChangeGenerate(false)"<?if ($_POST["NEW_GENERATE"] == "N") echo " checked";?>> <label class='generate' for="NEW_GENERATE_N"><?echo GetMessage("STOF_MY_PASSWORD")?></label></td>
						</tr>
						<?endif;?>
						<?if($arResult["AUTH"]["new_user_registration_email_confirmation"] != "Y"):?>
						<tr>
						...
						<?endif;?>
										<tr>
											...
											<td><?echo GetMessage("STOF_LOGIN")?> <span class="starrequired">*</span><br />
												<input type="text" class='any'  name="NEW_LOGIN" size="30" value="<?=$arResult["AUTH"]["NEW_LOGIN"]?>">
											</td>
										</tr>
										<tr>
											<?if($arResult["AUTH"]["new_user_registration_email_confirmation"] != "Y"):?>
											...
											<td>
												...
												<input type="password" class='any'  name="NEW_PASSWORD" size="30">
											</td>
										</tr>
										<tr>
											<?if($arResult["AUTH"]["new_user_registration_email_confirmation"] != "Y"):?>
											...
											<td>
												...
												<input type="password" class='any'  name="NEW_PASSWORD_CONFIRM" size="30">
											</td>
										</tr>
						<?if($arResult["AUTH"]["new_user_registration_email_confirmation"] != "Y"):?>
									</table>
						...
						<tr>
							<td>
								<input type="radio" id="NEW_GENERATE_Y" name="NEW_GENERATE" value="Y" OnClick="ChangeGenerate(true)"<?if ($POST["NEW_GENERATE"] != "N") echo " checked";?>> <label  class='generate' for="NEW_GENERATE_Y"><?echo GetMessage("STOF_SYS_PASSWORD")?></label>
						...
						if($arResult["AUTH"]["captcha_registration"] == "Y") //CAPTCHA
						{
							...
							<tr valign="middle">
								<td>
									...
									<input type="text" class='any'  name="captcha_word" size="30" maxlength="50" value="">
								</td>
							</tr>
							<?
						}
						...
						<tr>
							<td>
								<input type="submit" class='reg-button' value="<?echo GetMessage("STOF_NEXT_STEP")?>">
